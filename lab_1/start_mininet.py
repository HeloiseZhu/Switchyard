...
class PySwitchTopo(Topo):
    ...
    def __init__(self, args):
        ...
        # TODO: self.addHost('server2', **nodeconfig)
        self.addHost('hub', **nodeconfig)
        self.addHost('client', **nodeconfig)
        
        # TODO: for node in ['server1','server2','client']:
